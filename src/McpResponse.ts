      ...
      try {
        ...
        throw new Error(
          'The `@toon-format/toon` package is required to use --experimentalDataFormat=toon. ' +
            ...
            '- For npx: npx --package @async23/chrome-devtools-mcp@latest --package @toon-format/toon@latest chrome-devtools-mcp --experimentalDataFormat=toon\n' +
      ...
      try {
        ...
        throw new Error(
          'The `@blackwell-systems/gcf` package is required to use --experimentalDataFormat=gcf. ' +
            'Make sure the peer dependency is installed:\n' +
            '- For npx: npx --package @async23/chrome-devtools-mcp@latest --package @blackwell-systems/gcf@latest chrome-devtools-mcp --experimentalDataFormat=gcf\n' +
