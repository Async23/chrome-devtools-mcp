...
- **Old version running:** Run `chrome-devtools stop && npm uninstall -g @async23/chrome-devtools-mcp` before reinstalling, or ensure the latest version is being picked up by your path.
